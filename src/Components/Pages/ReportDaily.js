...
const ReportDaily = () => {
  ...
  return (
    <div className='report-daily'>
      ...
      <div ref={contentRef} className='report-daily__body' >

        {/* If theres nothing selected in the graph filter */}
        {selectedGraph.length === 0 && (
            <>
              <AverageSellingTImeGraph selectedDate={selectedDate} />
              <MostSoldProducts selectedDate={selectedDate} />
              <InventoryTurnOverGraph selectedDate={selectedDate} />
              <GmroiGraph selectedDate={selectedDate} />
            </>
          )}
